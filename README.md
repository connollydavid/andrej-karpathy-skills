...
`.claude/skills/` are symlinks into those submodules' skills, a reference rather
than a copy.

## Instantiate

```bash
git clone --recurse-submodules https://github.com/connollydavid/host-template my-project
cd my-project
